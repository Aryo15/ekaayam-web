    ...
    <div className="body">
      ...
      <main className="main">
         <section className="home section" id="home">
            ...
            <div class="home__container container grid tab_page">
                <div class="about__container container grid tab_page">
                    ...
                    <div class="about__image">
                        <img src={require('../assests/img/mentorship land page.webp')} alt="about image" class="about__img"/>
                    </div>
                </div>
         ...
         <section class="about section" id="about">
            <div class="about__container container grid">
                ...
                <div class="about__image">
                    <img src={require('../assests/img/Mentosrship Base.png')} alt="about image" class="about__img" />
